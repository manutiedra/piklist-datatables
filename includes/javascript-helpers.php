...
<?php
	 ...
	 * @since 0.0.1
	 */
	static function generate_cell_link($function_name, $link_text, $link_url, $id_name = null) {
?>
<script type="text/javascript">
    function <?php echo $function_name; ?>(data,type,row,meta)
    {
        var url = '<?php echo $link_url; ?>'<?php if ($id_name) { echo " + (row.$id_name)"; } ?>;
        return '<a href="' + url + '"><?php echo $link_text; ?></a>';
    }
</script>
<?php
	}
